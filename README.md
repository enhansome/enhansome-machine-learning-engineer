...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,636 | 🐛 106 | 📅 2026-09-02.
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,075 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,296 | 🐛 565 | 🌐 Python | 📅 2026-09-06 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,076 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,503 | 🐛 163 | 🌐 Python | 📅 2026-09-04 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,829 | 🐛 308 | 🌐 Python | 📅 2026-09-04 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,627 | 🐛 3,233 | 🌐 Python | 📅 2026-09-04 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,251 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,950 | 🐛 90 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
...
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,410 | 🐛 306 | 🌐 Python | 📅 2026-09-06 - Check your code's test coverage
* :snake: [safety](https://github.com/pyupio/safety) ⭐ 1,996 | 🐛 96 | 🌐 Python | 📅 2026-09-04 - Check that your dependencies don't have any known security vulnerabilities
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,154 | 🐛 91 | 🌐 Python | 📅 2026-09-01 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,701 | 🐛 1,178 | 🌐 Python | 📅 2026-09-06 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,951 | 🐛 47 | 🌐 Python | 📅 2026-09-03 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,308 | 🐛 614 | 🌐 Python | 📅 2026-09-06 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,422 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,732 | 🐛 32 | 🌐 Python | 📅 2026-08-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,730 | 🐛 988 | 🌐 Jupyter Notebook | 📅 2026-09-06 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,510 | 🐛 229 | 🌐 Python | 📅 2026-09-04 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,874 | 🐛 179 | 🌐 Python | 📅 2026-09-05 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,651 | 🐛 596 | 🌐 Python | 📅 2026-09-06 - A tool for labelling images (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,791 | 🐛 30 | 📅 2026-08-27 - An awesome list of Docker resources (30 min)
...
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,767 | 🐛 26 | 🌐 Shell | 📅 2026-09-05 - How to automate Terraform code quality checks with pre-commit (1 hour)
