...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,753 | 🐛 106 | 📅 2026-09-02.
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,084 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,306 | 🐛 1 | 🌐 Python | 📅 2026-09-10 to write your decorators (30 min)
...
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,089 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,512 | 🐛 163 | 🌐 Python | 📅 2026-09-15 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,842 | 🐛 307 | 🌐 Python | 📅 2026-09-16 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,641 | 🐛 3,232 | 🌐 Python | 📅 2026-09-16 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,268 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - Find common security issues
...
* :snake: [pytest-recording](https://github.com/kiwicom/pytest-recording) ⭐ 616 | 🐛 42 | 🌐 Python | 📅 2026-09-15 - Record and play back HTTP requests in your pytest tests
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,369 | 🐛 78 | 🌐 Python | 📅 2026-09-14 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,768 | 🐛 1,167 | 🌐 Python | 📅 2026-09-16 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,992 | 🐛 46 | 🌐 Python | 📅 2026-09-08 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,336 | 🐛 623 | 🌐 Python | 📅 2026-09-11 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,440 | 🐛 190 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,741 | 🐛 33 | 🌐 Python | 📅 2026-09-15 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,760 | 🐛 988 | 🌐 Jupyter Notebook | 📅 2026-09-16 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,521 | 🐛 231 | 🌐 Python | 📅 2026-09-16 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,894 | 🐛 177 | 🌐 Python | 📅 2026-09-16 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,725 | 🐛 586 | 🌐 Python | 📅 2026-09-16 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,770 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,835 | 🐛 32 | 📅 2026-09-12 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,796 | 🐛 41 | 🌐 Python | 📅 2026-09-16 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,774 | 🐛 27 | 🌐 Shell | 📅 2026-09-16 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 509 | 🐛 222 | 🌐 Python | 📅 2026-09-16 - How to produce and consume messages exactly once (1 hour)
