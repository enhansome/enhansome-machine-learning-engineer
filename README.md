...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,429 | 🐛 106 | 📅 2026-09-02.
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,080 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,298 | 🐛 568 | 🌐 Python | 📅 2026-09-11 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,087 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,507 | 🐛 164 | 🌐 Python | 📅 2026-09-10 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,073 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
* :snake: [cruft](https://github.com/cruft/cruft) ⭐ 1,586 | 🐛 94 | 🌐 Python | 📅 2024-12-25 - Update a Python package's underlying Cookiecutter scaffolding
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,840 | 🐛 313 | 🌐 Python | 📅 2026-09-11 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,638 | 🐛 3,238 | 🌐 Python | 📅 2026-09-11 - Check the type-correctness of your code
...
* :snake: [pre-commit hooks](https://github.com/pre-commit/pre-commit-hooks) ⭐ 6,678 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - A collection of [pre-commit](https://pre-commit.com/) hooks that check file quality
...
* :snake: [flake8 extensions](https://github.com/DmytroLitvinov/awesome-flake8-extensions) ⭐ 1,280 | 🐛 1 | 📅 2026-07-21 - An awesome list of Flake8 extensions
...
* :snake: [shellcheck](https://github.com/shellcheck-py/shellcheck-py) ⭐ 240 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Check the quality of your shell scripts
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,289 | 🐛 82 | 🌐 Python | 📅 2026-09-01 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,736 | 🐛 1,163 | 🌐 Python | 📅 2026-09-12 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,973 | 🐛 45 | 🌐 Python | 📅 2026-09-08 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,333 | 🐛 622 | 🌐 Python | 📅 2026-09-11 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,430 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,736 | 🐛 32 | 🌐 Python | 📅 2026-08-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,358 | 🐛 400 | 🌐 Python | 📅 2026-09-07 - Create interactive plots from pandas dataframes
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,742 | 🐛 983 | 🌐 Jupyter Notebook | 📅 2026-09-07 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [UMAP: Uniform Manifold Approximation and Projection](https://github.com/lmcinnes/umap) ⭐ 8,257 | 🐛 526 | 🌐 Python | 📅 2026-09-05 - How to reduce dimensionality for visualization and modelling (30 min)
...
* :snake: [Microsoft's Document Image Transformer](https://github.com/microsoft/unilm/tree/master/dit) ⭐ 22,213 | 🐛 685 | 🌐 Python | 📅 2026-08-26 - A self-supervised pre-trained model that achieves SotA performance on [PubLayNet](https://github.com/ibm-aur-nlp/PubLayNet) ⭐ 1,062 | 🐛 23 | 🌐 Jupyter Notebook | 📅 2025-07-09 and can be used for various downstream tasks (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,517 | 🐛 231 | 🌐 Python | 📅 2026-09-07 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,884 | 🐛 181 | 🌐 Python | 📅 2026-09-05 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,691 | 🐛 593 | 🌐 Python | 📅 2026-09-12 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,768 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
* :snake: [Awesome Data Labelling](https://github.com/heartexlabs/awesome-data-labeling) ⭐ 4,411 | 🐛 58 | 📅 2024-06-17 - An awesome list of data labelling tools (30 min)
...
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,073 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,811 | 🐛 31 | 📅 2026-09-12 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,785 | 🐛 37 | 🌐 Python | 📅 2026-09-11 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,772 | 🐛 26 | 🌐 Shell | 📅 2026-09-11 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 509 | 🐛 221 | 🌐 Python | 📅 2026-09-12 - How to produce and consume messages exactly once (1 hour)
