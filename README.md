...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,689 | 🐛 105 | 📅 2026-09-02.
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,072 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,302 | 🐛 0 | 🌐 Python | 📅 2026-08-30 to write your decorators (30 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,296 | 🐛 571 | 🌐 Python | 📅 2026-08-31 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,072 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
...
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,069 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,829 | 🐛 305 | 🌐 Python | 📅 2026-09-03 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,627 | 🐛 3,226 | 🌐 Python | 📅 2026-09-03 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,250 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,948 | 🐛 87 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
...
* :snake: [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,113 | 🐛 23 | 🌐 Python | 📅 2026-09-02 - Check that your code is written using the latest Python language features
...
* :snake: [safety](https://github.com/pyupio/safety) ⭐ 1,995 | 🐛 92 | 🌐 Python | 📅 2026-09-02 - Check that your dependencies don't have any known security vulnerabilities
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,063 | 🐛 81 | 🌐 Python | 📅 2026-09-01 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,678 | 🐛 1,188 | 🌐 Python | 📅 2026-09-03 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,945 | 🐛 45 | 🌐 Python | 📅 2026-09-03 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,307 | 🐛 610 | 🌐 Python | 📅 2026-08-31 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,412 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,727 | 🐛 988 | 🌐 Jupyter Notebook | 📅 2026-09-02 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,508 | 🐛 230 | 🌐 Python | 📅 2026-09-03 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,864 | 🐛 176 | 🌐 Python | 📅 2026-09-02 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,639 | 🐛 602 | 🌐 Python | 📅 2026-09-03 - A tool for labelling images (30 min)
...
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,069 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,769 | 🐛 28 | 📅 2026-08-27 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,768 | 🐛 46 | 🌐 Python | 📅 2026-09-03 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,766 | 🐛 26 | 🌐 Shell | 📅 2026-09-01 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 508 | 🐛 219 | 🌐 Python | 📅 2026-09-03 - How to produce and consume messages exactly once (1 hour)
