...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,893 | 🐛 105 | 📅 2026-08-21.
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,298 | 🐛 566 | 🌐 Python | 📅 2026-08-24 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,066 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,820 | 🐛 303 | 🌐 Python | 📅 2026-08-20 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,615 | 🐛 3,212 | 🌐 Python | 📅 2026-08-28 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,246 | 🐛 260 | 🌐 Python | 📅 2026-08-24 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,949 | 🐛 82 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
...
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,406 | 🐛 307 | 🌐 Python | 📅 2026-08-28 - Check your code's test coverage
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,914 | 🐛 79 | 🌐 Python | 📅 2026-08-26 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,632 | 🐛 1,182 | 🌐 Python | 📅 2026-08-29 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,934 | 🐛 44 | 🌐 Python | 📅 2026-08-28 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,302 | 🐛 605 | 🌐 Python | 📅 2026-08-17 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,387 | 🐛 188 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
...
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,357 | 🐛 397 | 🌐 Python | 📅 2026-08-24 - Create interactive plots from pandas dataframes
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,709 | 🐛 1,004 | 🌐 Jupyter Notebook | 📅 2026-08-29 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [UMAP: Uniform Manifold Approximation and Projection](https://github.com/lmcinnes/umap) ⭐ 8,256 | 🐛 525 | 🌐 Python | 📅 2026-08-21 - How to reduce dimensionality for visualization and modelling (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,510 | 🐛 229 | 🌐 Python | 📅 2026-08-21 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,862 | 🐛 176 | 🌐 Python | 📅 2026-08-25 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,615 | 🐛 595 | 🌐 Python | 📅 2026-08-28 - A tool for labelling images (30 min)
...
* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,769 | 🐛 460 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,064 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,736 | 🐛 25 | 📅 2026-08-27 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,745 | 🐛 31 | 🌐 Python | 📅 2026-08-28 - How to test and document your data and data pipelines (30 min)

### Shell

* :snake: [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,799 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to write safe and robust shell scripts (1 hour)
...
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,762 | 🐛 26 | 🌐 Shell | 📅 2026-08-26 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 504 | 🐛 216 | 🌐 Python | 📅 2026-08-28 - How to produce and consume messages exactly once (1 hour)
