...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,521 | 🐛 106 | 📅 2026-09-02.
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,079 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,294 | 🐛 566 | 🌐 Python | 📅 2026-09-09 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,084 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,506 | 🐛 164 | 🌐 Python | 📅 2026-09-09 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,072 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,836 | 🐛 310 | 🌐 Python | 📅 2026-09-04 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,634 | 🐛 3,231 | 🌐 Python | 📅 2026-09-09 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,256 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,952 | 🐛 93 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,211 | 🐛 81 | 🌐 Python | 📅 2026-09-01 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,724 | 🐛 1,160 | 🌐 Python | 📅 2026-09-09 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,967 | 🐛 45 | 🌐 Python | 📅 2026-09-08 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,330 | 🐛 615 | 🌐 Python | 📅 2026-09-07 - Easily add progress bars to long-running jobs
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,733 | 🐛 982 | 🌐 Jupyter Notebook | 📅 2026-09-07 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,513 | 🐛 229 | 🌐 Python | 📅 2026-09-07 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,880 | 🐛 179 | 🌐 Python | 📅 2026-09-05 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,671 | 🐛 591 | 🌐 Python | 📅 2026-09-09 - A tool for labelling images (30 min)
...
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,072 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,802 | 🐛 34 | 📅 2026-09-09 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,778 | 🐛 41 | 🌐 Python | 📅 2026-09-09 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,590 | 🐛 3 | 📅 2026-09-09 - An awesome list of Terraform resources (30 min)
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,770 | 🐛 26 | 🌐 Shell | 📅 2026-09-09 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 509 | 🐛 221 | 🌐 Python | 📅 2026-09-09 - How to produce and consume messages exactly once (1 hour)
