...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,613 | 🐛 106 | 📅 2026-09-02.
...
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,309 | 🐛 1 | 🌐 Python | 📅 2026-09-20 to write your decorators (30 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,309 | 🐛 557 | 🌐 Python | 📅 2026-09-21 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,100 | 🐛 316 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,849 | 🐛 305 | 🌐 Python | 📅 2026-09-21 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,646 | 🐛 3,235 | 🌐 Python | 📅 2026-09-21 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,277 | 🐛 258 | 🌐 Python | 📅 2026-09-21 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,953 | 🐛 82 | 🌐 Python | 📅 2026-09-21 - Automatically sort your import statements
...
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,410 | 🐛 307 | 🌐 Python | 📅 2026-09-21 - Check your code's test coverage
...
* :snake: [pytest-recording](https://github.com/kiwicom/pytest-recording) ⭐ 615 | 🐛 43 | 🌐 Python | 📅 2026-09-18 - Record and play back HTTP requests in your pytest tests
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,510 | 🐛 82 | 🌐 Python | 📅 2026-09-18 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,809 | 🐛 1,168 | 🌐 Python | 📅 2026-09-21 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 20,006 | 🐛 48 | 🌐 Python | 📅 2026-09-19 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,342 | 🐛 626 | 🌐 Python | 📅 2026-09-20 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,457 | 🐛 190 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,747 | 🐛 31 | 🌐 Python | 📅 2026-09-21 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
* :snake: [pdoc](https://github.com/mitmproxy/pdoc) ⭐ 2,512 | 🐛 71 | 🌐 Python | 📅 2026-07-01 - Generate API documentation for your code
* :snake: [birdseye](https://github.com/alexmojaki/birdseye) ⭐ 1,723 | 🐛 23 | 🌐 JavaScript | 📅 2026-01-11 - Graphically debug your Python code
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,772 | 🐛 984 | 🌐 Jupyter Notebook | 📅 2026-09-21 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,908 | 🐛 171 | 🌐 Python | 📅 2026-09-19 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,765 | 🐛 599 | 🌐 Python | 📅 2026-09-21 - A tool for labelling images (30 min)
...
* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,778 | 🐛 466 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,865 | 🐛 37 | 📅 2026-09-12 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,823 | 🐛 66 | 🌐 Python | 📅 2026-09-18 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,594 | 🐛 3 | 📅 2026-09-21 - An awesome list of Terraform resources (30 min)
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,776 | 🐛 27 | 🌐 Shell | 📅 2026-09-21 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 511 | 🐛 216 | 🌐 Python | 📅 2026-09-21 - How to produce and consume messages exactly once (1 hour)
