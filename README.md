...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,052 | 🐛 106 | 📅 2026-09-02.
...
* :hatched\_chick: [Poetry Cookiecutter](https://github.com/superlinear-ai/poetry-cookiecutter) ⭐ 374 | 🐛 16 | 🌐 Jinja | 📅 2026-08-19 - How to scaffold a modern Poetry-based development environment for Python packages and apps (30 min)
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,078 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,304 | 🐛 1 | 🌐 Python | 📅 2026-09-10 to write your decorators (30 min)
* :unicorn: [Effective Python](https://github.com/SigmaQuan/Better-Python-59-Ways/blob/master/README.md) ⭐ 1,384 | 🐛 25 | 🌐 Python | 📅 2023-06-13 - A collection of Python idioms (X hours)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,304 | 🐛 570 | 🌐 Python | 📅 2026-09-14 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,087 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,511 | 🐛 163 | 🌐 Python | 📅 2026-09-14 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,075 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
* :snake: [cruft](https://github.com/cruft/cruft) ⭐ 1,587 | 🐛 94 | 🌐 Python | 📅 2024-12-25 - Update a Python package's underlying Cookiecutter scaffolding
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,842 | 🐛 322 | 🌐 Python | 📅 2026-09-11 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,640 | 🐛 3,235 | 🌐 Python | 📅 2026-09-14 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,259 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,951 | 🐛 94 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
* :snake: [pre-commit hooks](https://github.com/pre-commit/pre-commit-hooks) ⭐ 6,679 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - A collection of [pre-commit](https://pre-commit.com/) hooks that check file quality
* :snake: [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,112 | 🐛 22 | 🌐 Python | 📅 2026-09-04 - Check that your code is written using the latest Python language features
* :snake: [flake8](https://github.com/PyCQA/flake8) ⭐ 3,823 | 🐛 23 | 🌐 Python | 📅 2026-08-17 - Check your code for bugs and that your code style is [PEP8](https://peps.python.org/pep-0008/)-compliant
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,412 | 🐛 306 | 🌐 Python | 📅 2026-09-13 - Check your code's test coverage
* :snake: [safety](https://github.com/pyupio/safety) ⭐ 1,997 | 🐛 98 | 🌐 Python | 📅 2026-09-04 - Check that your dependencies don't have any known security vulnerabilities
* :snake: [flake8 extensions](https://github.com/DmytroLitvinov/awesome-flake8-extensions) ⭐ 1,281 | 🐛 1 | 📅 2026-07-21 - An awesome list of Flake8 extensions
* :snake: [pydocstyle](https://github.com/PyCQA/pydocstyle) ⚠️ Archived - Check that your code is documented
* :snake: [pytest-recording](https://github.com/kiwicom/pytest-recording) ⭐ 616 | 🐛 40 | 🌐 Python | 📅 2026-07-20 - Record and play back HTTP requests in your pytest tests
...
* :snake: [shellcheck](https://github.com/shellcheck-py/shellcheck-py) ⭐ 241 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Check the quality of your shell scripts
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,336 | 🐛 77 | 🌐 Python | 📅 2026-09-14 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,749 | 🐛 1,163 | 🌐 Python | 📅 2026-09-14 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,982 | 🐛 46 | 🌐 Python | 📅 2026-09-08 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,335 | 🐛 622 | 🌐 Python | 📅 2026-09-11 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,435 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,738 | 🐛 32 | 🌐 Python | 📅 2026-08-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
* :snake: [pdoc](https://github.com/mitmproxy/pdoc) ⭐ 2,512 | 🐛 71 | 🌐 Python | 📅 2026-07-01 - Generate API documentation for your code
* :snake: [birdseye](https://github.com/alexmojaki/birdseye) ⭐ 1,722 | 🐛 23 | 🌐 JavaScript | 📅 2026-01-11 - Graphically debug your Python code
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,358 | 🐛 401 | 🌐 Python | 📅 2026-09-13 - Create interactive plots from pandas dataframes
* :snake: [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,116 | 🐛 115 | 🌐 Python | 📅 2025-02-20 - Release a new version of your package
* :snake: [coloredlogs](https://github.com/xolox/python-coloredlogs) ⭐ 558 | 🐛 37 | 🌐 Python | 📅 2024-06-12 - Increase your logs' readability with colour
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,757 | 🐛 989 | 🌐 Jupyter Notebook | 📅 2026-09-14 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [UMAP: Uniform Manifold Approximation and Projection](https://github.com/lmcinnes/umap) ⭐ 8,258 | 🐛 525 | 🌐 Python | 📅 2026-09-13 - How to reduce dimensionality for visualization and modelling (30 min)
* :snake: [PyNNDescent](https://github.com/lmcinnes/pynndescent) ⭐ 970 | 🐛 79 | 🌐 Python | 📅 2026-08-01 - How to find nearest neighbours in huge datasets (15 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,519 | 🐛 231 | 🌐 Python | 📅 2026-09-07 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,889 | 🐛 178 | 🌐 Python | 📅 2026-09-14 - A comparison of recommender system models (30 min)
...
* :snake: [Awesome Pandas](https://github.com/tommyod/awesome-pandas) ⭐ 574 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-04 - An awesome list of Pandas resources (1 hour)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,708 | 🐛 590 | 🌐 Python | 📅 2026-09-14 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,768 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
* :snake: [Awesome Data Labelling](https://github.com/heartexlabs/awesome-data-labeling) ⭐ 4,410 | 🐛 58 | 📅 2024-06-17 - An awesome list of data labelling tools (30 min)

## DevOps

### CI/CD

* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,777 | 🐛 462 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,075 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,820 | 🐛 32 | 📅 2026-09-12 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,794 | 🐛 42 | 🌐 Python | 📅 2026-09-14 - How to test and document your data and data pipelines (30 min)

### Shell

* :snake: [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,804 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to write safe and robust shell scripts (1 hour)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,592 | 🐛 5 | 📅 2026-09-09 - An awesome list of Terraform resources (30 min)
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,772 | 🐛 27 | 🌐 Shell | 📅 2026-09-11 - How to automate Terraform code quality checks with pre-commit (1 hour)
* :snake: [Terraform best practices](https://github.com/ozbillwang/terraform-best-practices) ⭐ 1,841 | 🐛 2 | 🌐 HCL | 📅 2024-12-20 - Terraform best practices (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 509 | 🐛 220 | 🌐 Python | 📅 2026-09-14 - How to produce and consume messages exactly once (1 hour)
