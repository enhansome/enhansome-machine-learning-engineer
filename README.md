...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,023 | 🐛 105 | 📅 2026-08-21.
...
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,299 | 🐛 0 | 🌐 Python | 📅 2026-08-30 to write your decorators (30 min)
...
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,069 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,829 | 🐛 316 | 🌐 Python | 📅 2026-09-01 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,625 | 🐛 3,219 | 🌐 Python | 📅 2026-09-01 - Check the type-correctness of your code
...
* :snake: [flake8](https://github.com/PyCQA/flake8) ⭐ 3,824 | 🐛 23 | 🌐 Python | 📅 2026-08-17 - Check your code for bugs and that your code style is [PEP8](https://peps.python.org/pep-0008/)-compliant
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,411 | 🐛 305 | 🌐 Python | 📅 2026-08-31 - Check your code's test coverage
* :snake: [safety](https://github.com/pyupio/safety) ⭐ 1,995 | 🐛 93 | 🌐 Python | 📅 2026-08-28 - Check that your dependencies don't have any known security vulnerabilities
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,005 | 🐛 82 | 🌐 Python | 📅 2026-09-01 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,658 | 🐛 1,194 | 🌐 Python | 📅 2026-09-01 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,942 | 🐛 48 | 🌐 Python | 📅 2026-09-01 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,306 | 🐛 604 | 🌐 Python | 📅 2026-08-31 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,401 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,727 | 🐛 31 | 🌐 Python | 📅 2026-08-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,356 | 🐛 396 | 🌐 Python | 📅 2026-08-31 - Create interactive plots from pandas dataframes
...
* :snake: [coloredlogs](https://github.com/xolox/python-coloredlogs) ⭐ 560 | 🐛 37 | 🌐 Python | 📅 2024-06-12 - Increase your logs' readability with colour
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,722 | 🐛 998 | 🌐 Jupyter Notebook | 📅 2026-09-01 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,509 | 🐛 230 | 🌐 Python | 📅 2026-08-21 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,861 | 🐛 178 | 🌐 Python | 📅 2026-08-31 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,632 | 🐛 601 | 🌐 Python | 📅 2026-09-01 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,761 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,761 | 🐛 27 | 📅 2026-08-27 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,763 | 🐛 43 | 🌐 Python | 📅 2026-09-01 - How to test and document your data and data pipelines (30 min)

### Shell

* :snake: [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,801 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to write safe and robust shell scripts (1 hour)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,587 | 🐛 11 | 📅 2026-08-25 - An awesome list of Terraform resources (30 min)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 505 | 🐛 217 | 🌐 Python | 📅 2026-09-01 - How to produce and consume messages exactly once (1 hour)
