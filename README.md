...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,374 | 🐛 105 | 📅 2026-09-02.
...
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,300 | 🐛 0 | 🌐 Python | 📅 2026-08-30 to write your decorators (30 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,295 | 🐛 571 | 🌐 Python | 📅 2026-08-31 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,073 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,499 | 🐛 162 | 🌐 Python | 📅 2026-08-25 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,068 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,830 | 🐛 317 | 🌐 Python | 📅 2026-09-01 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,624 | 🐛 3,224 | 🌐 Python | 📅 2026-09-02 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,249 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,949 | 🐛 86 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
* :snake: [pre-commit hooks](https://github.com/pre-commit/pre-commit-hooks) ⭐ 6,673 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - A collection of [pre-commit](https://pre-commit.com/) hooks that check file quality
* :snake: [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,113 | 🐛 22 | 🌐 Python | 📅 2026-09-02 - Check that your code is written using the latest Python language features
* :snake: [flake8](https://github.com/PyCQA/flake8) ⭐ 3,825 | 🐛 23 | 🌐 Python | 📅 2026-08-17 - Check your code for bugs and that your code style is [PEP8](https://peps.python.org/pep-0008/)-compliant
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,411 | 🐛 305 | 🌐 Python | 📅 2026-08-31 - Check your code's test coverage
* :snake: [safety](https://github.com/pyupio/safety) ⭐ 1,995 | 🐛 93 | 🌐 Python | 📅 2026-09-02 - Check that your dependencies don't have any known security vulnerabilities
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,034 | 🐛 81 | 🌐 Python | 📅 2026-09-01 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,666 | 🐛 1,181 | 🌐 Python | 📅 2026-09-02 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,941 | 🐛 45 | 🌐 Python | 📅 2026-09-02 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,308 | 🐛 605 | 🌐 Python | 📅 2026-08-31 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,409 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,730 | 🐛 31 | 🌐 Python | 📅 2026-08-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
* :snake: [pdoc](https://github.com/mitmproxy/pdoc) ⭐ 2,513 | 🐛 70 | 🌐 Python | 📅 2026-07-01 - Generate API documentation for your code
* :snake: [birdseye](https://github.com/alexmojaki/birdseye) ⭐ 1,720 | 🐛 23 | 🌐 JavaScript | 📅 2026-01-11 - Graphically debug your Python code
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,357 | 🐛 397 | 🌐 Python | 📅 2026-09-02 - Create interactive plots from pandas dataframes
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,725 | 🐛 995 | 🌐 Jupyter Notebook | 📅 2026-09-02 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [UMAP: Uniform Manifold Approximation and Projection](https://github.com/lmcinnes/umap) ⭐ 8,257 | 🐛 525 | 🌐 Python | 📅 2026-08-31 - How to reduce dimensionality for visualization and modelling (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,508 | 🐛 230 | 🌐 Python | 📅 2026-08-21 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,861 | 🐛 176 | 🌐 Python | 📅 2026-09-02 - A comparison of recommender system models (30 min)
...
* :snake: [Awesome Pandas](https://github.com/tommyod/awesome-pandas) ⭐ 573 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-04 - An awesome list of Pandas resources (1 hour)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,636 | 🐛 599 | 🌐 Python | 📅 2026-09-02 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,762 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
* :snake: [Awesome Data Labelling](https://github.com/heartexlabs/awesome-data-labeling) ⭐ 4,412 | 🐛 57 | 📅 2024-06-17 - An awesome list of data labelling tools (30 min)

## DevOps

### CI/CD

* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,774 | 🐛 461 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,068 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,764 | 🐛 27 | 📅 2026-08-27 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,766 | 🐛 46 | 🌐 Python | 📅 2026-09-02 - How to test and document your data and data pipelines (30 min)

### Shell

* :snake: [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,802 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to write safe and robust shell scripts (1 hour)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,588 | 🐛 12 | 📅 2026-08-25 - An awesome list of Terraform resources (30 min)
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,767 | 🐛 26 | 🌐 Shell | 📅 2026-09-01 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 508 | 🐛 216 | 🌐 Python | 📅 2026-09-02 - How to produce and consume messages exactly once (1 hour)
