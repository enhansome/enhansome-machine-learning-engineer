...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,208 | 🐛 105 | 📅 2026-08-21.
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,293 | 🐛 565 | 🌐 Python | 📅 2026-08-24 - Manage the packaging and dependencies of your Python project
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,816 | 🐛 303 | 🌐 Python | 📅 2026-08-20 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,605 | 🐛 3,203 | 🌐 Python | 📅 2026-08-25 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,241 | 🐛 260 | 🌐 Python | 📅 2026-08-24 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,947 | 🐛 84 | 🌐 Python | 📅 2026-08-26 - Automatically sort your import statements
...
* :snake: [flake8](https://github.com/PyCQA/flake8) ⭐ 3,819 | 🐛 23 | 🌐 Python | 📅 2026-08-17 - Check your code for bugs and that your code style is [PEP8](https://peps.python.org/pep-0008/)-compliant
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,407 | 🐛 307 | 🌐 Python | 📅 2026-08-25 - Check your code's test coverage
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,864 | 🐛 78 | 🌐 Python | 📅 2026-08-26 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,620 | 🐛 1,191 | 🌐 Python | 📅 2026-08-26 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,929 | 🐛 44 | 🌐 Python | 📅 2026-08-25 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,292 | 🐛 604 | 🌐 Python | 📅 2026-08-17 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,379 | 🐛 188 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
...
* :snake: [pdoc](https://github.com/mitmproxy/pdoc) ⭐ 2,510 | 🐛 69 | 🌐 Python | 📅 2026-07-01 - Generate API documentation for your code
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,704 | 🐛 1,009 | 🌐 Jupyter Notebook | 📅 2026-08-24 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,600 | 🐛 588 | 🌐 Python | 📅 2026-08-26 - A tool for labelling images (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,721 | 🐛 18 | 📅 2026-08-19 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,740 | 🐛 38 | 🌐 Python | 📅 2026-08-26 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 504 | 🐛 215 | 🌐 Python | 📅 2026-08-26 - How to produce and consume messages exactly once (1 hour)
