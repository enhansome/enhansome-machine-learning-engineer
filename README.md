# Awesome Machine Learning Engineer with stars

<div align="center">

<img height="280" src="https://github.com/sindresorhus/awesome/raw/main/media/logo.svg?sanitize=true" alt="Awesome">

For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,056 | 🐛 100 | 📅 2026-06-30.
...
* There are three content levels:
  1. :hatched\_chick: Essential reading for all ML engineers
...
* :hatched\_chick: [BLUF: The Military Standard That Can Make Your Writing More Powerful](https://www.animalz.co/blog/bottom-line-up-front/) - How to make your communication more powerful (5 min)
* :hatched\_chick: [The XY Problem](http://xyproblem.info/) - How to focus on explaining your end goal when asking for help (5 min)
* :hatched\_chick: [Bike-shedding: how mature are you as an engineer?](https://no-kill-switch.ghost.io/bike-shedding-how-mature-are-you-as-an-engineer/) - How to avoid and call out bike-shedding (5 min)
* :hatched\_chick: [E-mail like a boss](https://pbs.twimg.com/media/D7LgaoMW4Acy6hL?format=jpg\&name=large) - How to write better e-mails (5 min)
* :hatched\_chick: [Stop Swiss Cheesing your calendar](https://thinkingthrough.substack.com/p/stop-swiss-cheesing-your-calendar?s=r) - How to manage your calendar so you can focus (15 min)
* :hatched\_chick: [How to write in plain English](http://www.plainenglish.co.uk/how-to-write-in-plain-english.html) - How to write in plain English (30 min)
* :hatched\_chick: [Presentation Rules](http://www.jilles.net/perma/2020/06/05/presentation-rules.html) - How to create a great slide deck (30 min)
...
* :hatched\_chick: [Semantic Versioning](https://semver.org/) - How to bump the version of your apps and packages (15 min)
* :hatched\_chick: [`__all__` and wild imports in Python](http://xion.io/post/code/python-all-wild-imports.html) - How `__all__` defines the public API of your Python packages (15 min)
* :hatched\_chick: [APIs for Machine Learning](https://madewithml.com/courses/mlops/api/) - How to design RESTful APIs for Machine Learning applications (30 min)
...
* :hatched\_chick: [Poetry Cookiecutter](https://github.com/superlinear-ai/poetry-cookiecutter) ⭐ 373 | 🐛 17 | 🌐 Jinja | 📅 2026-02-20 - How to scaffold a modern Poetry-based development environment for Python packages and apps (30 min)
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,050 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,293 | 🐛 0 | 🌐 Python | 📅 2026-08-12 to write your decorators (30 min)
* :unicorn: [Effective Python](https://github.com/SigmaQuan/Better-Python-59-Ways/blob/master/README.md) ⭐ 1,383 | 🐛 25 | 🌐 Python | 📅 2023-06-13 - A collection of Python idioms (X hours)
...
* :hatched\_chick: [Understanding Python's logging module](https://www.electricmonk.nl/log/2017/08/06/understanding-pythons-logging-module/) - How to use the `logging` module effectively (30 min)
...
* :snake: [Magic number](https://en.wikipedia.org/wiki/Magic_number_\(programming\)#Unnamed_numerical_constants) - Why *magic values* are an anti-pattern (15 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,289 | 🐛 564 | 🌐 Python | 📅 2026-08-10 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,055 | 🐛 311 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,494 | 🐛 179 | 🌐 Python | 📅 2026-08-10 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,060 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
* :snake: [cruft](https://github.com/cruft/cruft) ⭐ 1,582 | 🐛 94 | 🌐 Python | 📅 2024-12-25 - Update a Python package's underlying Cookiecutter scaffolding
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,798 | 🐛 301 | 🌐 Python | 📅 2026-08-10 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,591 | 🐛 3,175 | 🌐 Python | 📅 2026-08-12 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,209 | 🐛 258 | 🌐 Python | 📅 2026-08-04 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,949 | 🐛 90 | 🌐 Python | 📅 2026-08-11 - Automatically sort your import statements
* :snake: [pre-commit hooks](https://github.com/pre-commit/pre-commit-hooks) ⭐ 6,660 | 🐛 7 | 🌐 Python | 📅 2026-07-24 - A collection of [pre-commit](https://pre-commit.com/) hooks that check file quality
* :snake: [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,111 | 🐛 20 | 🌐 Python | 📅 2026-08-12 - Check that your code is written using the latest Python language features
* :snake: [flake8](https://github.com/PyCQA/flake8) ⭐ 3,813 | 🐛 23 | 🌐 Python | 📅 2026-07-14 - Check your code for bugs and that your code style is [PEP8](https://peps.python.org/pep-0008/)-compliant
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,407 | 🐛 303 | 🌐 Python | 📅 2026-08-09 - Check your code's test coverage
* :snake: [safety](https://github.com/pyupio/safety) ⭐ 1,995 | 🐛 88 | 🌐 Python | 📅 2026-07-21 - Check that your dependencies don't have any known security vulnerabilities
* :snake: [flake8 extensions](https://github.com/DmytroLitvinov/awesome-flake8-extensions) ⭐ 1,279 | 🐛 1 | 📅 2026-07-21 - An awesome list of Flake8 extensions
...
* :snake: [pygrep hooks](https://github.com/pre-commit/pygrep-hooks) ⭐ 243 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - A collection of [pre-commit](https://pre-commit.com/) hooks that check for common Python code smells
* :snake: [shellcheck](https://github.com/shellcheck-py/shellcheck-py) ⭐ 238 | 🐛 0 | 🌐 Python | 📅 2026-07-14 - Check the quality of your shell scripts
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,547 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,541 | 🐛 1,202 | 🌐 Python | 📅 2026-08-13 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,893 | 🐛 42 | 🌐 Python | 📅 2026-08-12 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,277 | 🐛 588 | 🌐 Python | 📅 2026-08-10 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,336 | 🐛 185 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,721 | 🐛 28 | 🌐 Python | 📅 2026-06-08 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
* :snake: [pdoc](https://github.com/mitmproxy/pdoc) ⭐ 2,511 | 🐛 69 | 🌐 Python | 📅 2026-07-01 - Generate API documentation for your code
* :snake: [birdseye](https://github.com/alexmojaki/birdseye) ⭐ 1,718 | 🐛 23 | 🌐 JavaScript | 📅 2026-01-11 - Graphically debug your Python code
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,356 | 🐛 397 | 🌐 Python | 📅 2026-08-06 - Create interactive plots from pandas dataframes
* :snake: [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,115 | 🐛 115 | 🌐 Python | 📅 2025-02-20 - Release a new version of your package
* :snake: [coloredlogs](https://github.com/xolox/python-coloredlogs) ⭐ 559 | 🐛 37 | 🌐 Python | 📅 2024-06-12 - Increase your logs' readability with colour
* :snake: [scalene](https://github.com/emeryberger/scalene) ⭐ 239 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-14 - Profile your code's CPU and memory usage by line
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,682 | 🐛 1,017 | 🌐 Jupyter Notebook | 📅 2026-08-11 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [UMAP: Uniform Manifold Approximation and Projection](https://github.com/lmcinnes/umap) ⭐ 8,251 | 🐛 524 | 🌐 Python | 📅 2026-08-10 - How to reduce dimensionality for visualization and modelling (30 min)
* :snake: [PyNNDescent](https://github.com/lmcinnes/pynndescent) ⭐ 969 | 🐛 78 | 🌐 Python | 📅 2026-08-01 - How to find nearest neighbours in huge datasets (15 min)

### Classification

* :hatched\_chick: [Precision and recall](https://en.wikipedia.org/wiki/Precision_and_recall) - How precision and recall measure a classifier's performance (30 min)
...
* :snake: [Microsoft's Document Image Transformer](https://github.com/microsoft/unilm/tree/master/dit) ⭐ 22,186 | 🐛 684 | 🌐 Python | 📅 2026-01-23 - A self-supervised pre-trained model that achieves SotA performance on [PubLayNet](https://github.com/ibm-aur-nlp/PubLayNet) ⭐ 1,055 | 🐛 23 | 🌐 Jupyter Notebook | 📅 2025-07-09 and can be used for various downstream tasks (30 min)

### Natural Language Processing

* :snake: [Awesome Sentence Embedding](https://github.com/Separius/awesome-sentence-embedding) ⚠️ Archived - A curated list of pretrained sentence and word embedding models (15 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,491 | 🐛 217 | 🌐 Python | 📅 2026-08-06 - How to build forecasting models with `darts` (1 hour)

### Recommender Systems

* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,851 | 🐛 176 | 🌐 Python | 📅 2026-08-10 - A comparison of recommender system models (30 min)
...
* :snake: [Awesome Pandas](https://github.com/tommyod/awesome-pandas) ⭐ 574 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-06-04 - An awesome list of Pandas resources (1 hour)

### Sci-kit learn

* :hatched\_chick: [Using scikit-learn Pipelines and FeatureUnions](http://zacstewart.com/2014/08/05/pipelines-of-featureunions-of-pipelines.html) - How to use `Pipeline`s to build end-to-end models (30 min)
* :hatched\_chick: [Transforming target in regression](https://scikit-learn.org/stable/modules/compose.html#transformed-target-regressor) - How to transform the target to build more robust models (15 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,507 | 🐛 600 | 🌐 Python | 📅 2026-08-12 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,736 | 🐛 396 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
* :snake: [Awesome Data Labelling](https://github.com/heartexlabs/awesome-data-labeling) ⭐ 4,395 | 🐛 57 | 📅 2024-06-17 - An awesome list of data labelling tools (30 min)

## DevOps

### CI/CD

* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,768 | 🐛 457 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,060 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)

### Environment and dependency management

* :hatched\_chick: [Intro to packaging and dependency management for Python with Poetry](https://curvestone.io/intro-to-packaging-and-dependency-management-for-python-with-poetry/) - How to manage your Python package's dependencies and environment (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,626 | 🐛 22 | 📅 2026-07-29 - An awesome list of Docker resources (30 min)

### Data pipelines

* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,708 | 🐛 38 | 🌐 Python | 📅 2026-08-13 - How to test and document your data and data pipelines (30 min)
...
* :snake: [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,797 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to write safe and robust shell scripts (1 hour)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,565 | 🐛 13 | 📅 2026-07-27 - An awesome list of Terraform resources (30 min)
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,755 | 🐛 30 | 🌐 Shell | 📅 2026-08-12 - How to automate Terraform code quality checks with pre-commit (1 hour)
* :snake: [Terraform best practices](https://github.com/ozbillwang/terraform-best-practices) ⭐ 1,843 | 🐛 2 | 🌐 HCL | 📅 2024-12-20 - Terraform best practices (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 500 | 🐛 216 | 🌐 Python | 📅 2026-08-13 - How to produce and consume messages exactly once (1 hour)
