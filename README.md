...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,228 | 🐛 106 | 📅 2026-09-02.
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,086 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,309 | 🐛 0 | 🌐 Python | 📅 2026-09-20 to write your decorators (30 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,303 | 🐛 555 | 🌐 Python | 📅 2026-09-20 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,096 | 🐛 316 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,514 | 🐛 163 | 🌐 Python | 📅 2026-09-18 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,077 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,848 | 🐛 312 | 🌐 Python | 📅 2026-09-18 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,645 | 🐛 3,231 | 🌐 Python | 📅 2026-09-20 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,276 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,954 | 🐛 99 | 🌐 Python | 📅 2026-09-19 - Automatically sort your import statements
* :snake: [pre-commit hooks](https://github.com/pre-commit/pre-commit-hooks) ⭐ 6,684 | 🐛 7 | 🌐 Python | 📅 2026-08-17 - A collection of [pre-commit](https://pre-commit.com/) hooks that check file quality
* :snake: [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,111 | 🐛 23 | 🌐 Python | 📅 2026-09-04 - Check that your code is written using the latest Python language features
...
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,410 | 🐛 309 | 🌐 Python | 📅 2026-09-20 - Check your code's test coverage
* :snake: [safety](https://github.com/pyupio/safety) ⭐ 1,997 | 🐛 97 | 🌐 Python | 📅 2026-09-04 - Check that your dependencies don't have any known security vulnerabilities
...
* :snake: [pytest-recording](https://github.com/kiwicom/pytest-recording) ⭐ 616 | 🐛 43 | 🌐 Python | 📅 2026-09-18 - Record and play back HTTP requests in your pytest tests
...
* :snake: [shellcheck](https://github.com/shellcheck-py/shellcheck-py) ⭐ 242 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Check the quality of your shell scripts
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,488 | 🐛 83 | 🌐 Python | 📅 2026-09-18 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,803 | 🐛 1,166 | 🌐 Python | 📅 2026-09-20 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 20,000 | 🐛 48 | 🌐 Python | 📅 2026-09-19 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,341 | 🐛 626 | 🌐 Python | 📅 2026-09-11 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,453 | 🐛 190 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,747 | 🐛 32 | 🌐 Python | 📅 2026-09-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,358 | 🐛 402 | 🌐 Python | 📅 2026-09-19 - Create interactive plots from pandas dataframes
* :snake: [bump2version](https://github.com/c4urself/bump2version) ⭐ 1,117 | 🐛 115 | 🌐 Python | 📅 2025-02-20 - Release a new version of your package
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,767 | 🐛 989 | 🌐 Jupyter Notebook | 📅 2026-09-20 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [UMAP: Uniform Manifold Approximation and Projection](https://github.com/lmcinnes/umap) ⭐ 8,259 | 🐛 525 | 🌐 Python | 📅 2026-09-15 - How to reduce dimensionality for visualization and modelling (30 min)
...
* :snake: [Microsoft's Document Image Transformer](https://github.com/microsoft/unilm/tree/master/dit) ⭐ 22,220 | 🐛 686 | 🌐 Python | 📅 2026-09-15 - A self-supervised pre-trained model that achieves SotA performance on [PubLayNet](https://github.com/ibm-aur-nlp/PubLayNet) ⭐ 1,063 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2025-07-09 and can be used for various downstream tasks (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,520 | 🐛 220 | 🌐 Python | 📅 2026-09-18 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,907 | 🐛 177 | 🌐 Python | 📅 2026-09-19 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,755 | 🐛 593 | 🌐 Python | 📅 2026-09-20 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,771 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
* :snake: [Awesome Data Labelling](https://github.com/heartexlabs/awesome-data-labeling) ⭐ 4,412 | 🐛 58 | 📅 2024-06-17 - An awesome list of data labelling tools (30 min)

## DevOps

### CI/CD

* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,778 | 🐛 464 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,077 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,857 | 🐛 37 | 📅 2026-09-12 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,818 | 🐛 66 | 🌐 Python | 📅 2026-09-18 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,593 | 🐛 7 | 📅 2026-09-09 - An awesome list of Terraform resources (30 min)
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,776 | 🐛 27 | 🌐 Shell | 📅 2026-09-17 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 510 | 🐛 218 | 🌐 Python | 📅 2026-09-20 - How to produce and consume messages exactly once (1 hour)
