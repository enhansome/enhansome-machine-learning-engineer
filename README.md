...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,599 | 🐛 105 | 📅 2026-08-21.
...
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,294 | 🐛 0 | 🌐 Python | 📅 2026-08-21 to write your decorators (30 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,288 | 🐛 565 | 🌐 Python | 📅 2026-08-17 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,059 | 🐛 313 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,815 | 🐛 301 | 🌐 Python | 📅 2026-08-20 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,598 | 🐛 3,195 | 🌐 Python | 📅 2026-08-21 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,228 | 🐛 259 | 🌐 Python | 📅 2026-08-04 - Find common security issues
...
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,407 | 🐛 307 | 🌐 Python | 📅 2026-08-19 - Check your code's test coverage
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,743 | 🐛 75 | 🌐 Python | 📅 2026-08-19 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,580 | 🐛 1,181 | 🌐 Python | 📅 2026-08-21 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,914 | 🐛 44 | 🌐 Python | 📅 2026-08-12 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,280 | 🐛 602 | 🌐 Python | 📅 2026-08-17 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,364 | 🐛 186 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
...
* :snake: [pdoc](https://github.com/mitmproxy/pdoc) ⭐ 2,509 | 🐛 69 | 🌐 Python | 📅 2026-07-01 - Generate API documentation for your code
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,695 | 🐛 1,010 | 🌐 Jupyter Notebook | 📅 2026-08-11 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,497 | 🐛 224 | 🌐 Python | 📅 2026-08-21 - How to build forecasting models with `darts` (1 hour)

### Recommender Systems

* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,864 | 🐛 176 | 🌐 Python | 📅 2026-08-20 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,560 | 🐛 588 | 🌐 Python | 📅 2026-08-21 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,753 | 🐛 395 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
...
* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,768 | 🐛 459 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,681 | 🐛 14 | 📅 2026-08-19 - An awesome list of Docker resources (30 min)

### Data pipelines

* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,730 | 🐛 35 | 🌐 Python | 📅 2026-08-21 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 503 | 🐛 216 | 🌐 Python | 📅 2026-08-21 - How to produce and consume messages exactly once (1 hour)
