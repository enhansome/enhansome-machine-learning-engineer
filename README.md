...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,721 | 🐛 105 | 📅 2026-08-21.
...
* :unicorn: [What the f\*ck Python!](https://github.com/satwikkansal/wtfpython) ⭐ 37,071 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - How to master Python by understanding its edge cases (1 day)
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,296 | 🐛 0 | 🌐 Python | 📅 2026-08-30 to write your decorators (30 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,294 | 🐛 571 | 🌐 Python | 📅 2026-08-31 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,070 | 🐛 312 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
...
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,067 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - Define and run tasks in a Poetry project with Poe the Poet
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,826 | 🐛 311 | 🌐 Python | 📅 2026-08-31 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,624 | 🐛 3,216 | 🌐 Python | 📅 2026-08-29 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,248 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,949 | 🐛 85 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
* :snake: [pre-commit hooks](https://github.com/pre-commit/pre-commit-hooks) ⭐ 6,674 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - A collection of [pre-commit](https://pre-commit.com/) hooks that check file quality
...
* :snake: [coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,409 | 🐛 305 | 🌐 Python | 📅 2026-08-31 - Check your code's test coverage
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,976 | 🐛 80 | 🌐 Python | 📅 2026-08-26 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,652 | 🐛 1,187 | 🌐 Python | 📅 2026-08-31 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,939 | 🐛 44 | 🌐 Python | 📅 2026-08-28 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,307 | 🐛 604 | 🌐 Python | 📅 2026-08-31 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,400 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,726 | 🐛 30 | 🌐 Python | 📅 2026-08-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,356 | 🐛 397 | 🌐 Python | 📅 2026-08-31 - Create interactive plots from pandas dataframes
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,718 | 🐛 999 | 🌐 Jupyter Notebook | 📅 2026-08-31 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,510 | 🐛 230 | 🌐 Python | 📅 2026-08-21 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,859 | 🐛 178 | 🌐 Python | 📅 2026-08-31 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,628 | 🐛 602 | 🌐 Python | 📅 2026-08-31 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,760 | 🐛 398 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
* :snake: [Awesome Data Labelling](https://github.com/heartexlabs/awesome-data-labeling) ⭐ 4,409 | 🐛 57 | 📅 2024-06-17 - An awesome list of data labelling tools (30 min)

## DevOps

### CI/CD

* :snake: [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,773 | 🐛 461 | 🌐 Python | 📅 2026-04-07 - How to implement common tasks you run on your project as a CLI (30 min)
* :snake: [poe](https://github.com/nat-n/poethepoet) ⭐ 2,067 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - How to implement common tasks you run on your project as a CLI (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,753 | 🐛 27 | 📅 2026-08-27 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,760 | 🐛 29 | 🌐 Python | 📅 2026-08-31 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Awesome Terraform](https://github.com/shuaibiyy/awesome-terraform) ⭐ 6,584 | 🐛 10 | 📅 2026-08-25 - An awesome list of Terraform resources (30 min)
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,762 | 🐛 26 | 🌐 Shell | 📅 2026-08-29 - How to automate Terraform code quality checks with pre-commit (1 hour)
...
* :unicorn: [Kafka Exactly-Once-Semantics](https://github.com/confluentinc/confluent-kafka-python/releases/tag/v1.4.0) ⭐ 505 | 🐛 218 | 🌐 Python | 📅 2026-08-30 - How to produce and consume messages exactly once (1 hour)
