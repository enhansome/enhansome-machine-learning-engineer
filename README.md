...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,497 | 🐛 106 | 📅 2026-09-02.
...
* :snake: [Please fix your decorators](https://hynek.me/articles/decorators/) - Why you should probably use [`wrapt`](https://github.com/GrahamDumpleton/wrapt) ⭐ 2,307 | 🐛 1 | 🌐 Python | 📅 2026-09-10 to write your decorators (30 min)
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,305 | 🐛 563 | 🌐 Python | 📅 2026-09-18 - Manage the packaging and dependencies of your Python project
* :snake: [cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 25,094 | 🐛 313 | 🌐 Python | 📅 2026-04-01 - Scaffold new Python packages or apps quickly with a Cookiecutter template
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,513 | 🐛 163 | 🌐 Python | 📅 2026-09-18 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,848 | 🐛 311 | 🌐 Python | 📅 2026-09-18 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,644 | 🐛 3,235 | 🌐 Python | 📅 2026-09-18 - Check the type-correctness of your code
* :snake: [bandit](https://github.com/PyCQA/bandit) ⭐ 8,272 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - Find common security issues
* :hatched\_chick: [isort](https://github.com/PyCQA/isort) ⭐ 6,954 | 🐛 97 | 🌐 Python | 📅 2026-08-27 - Automatically sort your import statements
...
* :snake: [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,113 | 🐛 22 | 🌐 Python | 📅 2026-09-04 - Check that your code is written using the latest Python language features
...
* :snake: [pytest-recording](https://github.com/kiwicom/pytest-recording) ⭐ 616 | 🐛 42 | 🌐 Python | 📅 2026-09-17 - Record and play back HTTP requests in your pytest tests
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,431 | 🐛 81 | 🌐 Python | 📅 2026-09-18 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,780 | 🐛 1,167 | 🌐 Python | 📅 2026-09-18 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,995 | 🐛 47 | 🌐 Python | 📅 2026-09-08 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,339 | 🐛 625 | 🌐 Python | 📅 2026-09-11 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,449 | 🐛 190 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,744 | 🐛 32 | 🌐 Python | 📅 2026-09-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,358 | 🐛 402 | 🌐 Python | 📅 2026-09-13 - Create interactive plots from pandas dataframes
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,761 | 🐛 990 | 🌐 Jupyter Notebook | 📅 2026-09-18 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,521 | 🐛 219 | 🌐 Python | 📅 2026-09-18 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [Microsoft Recommenders](https://github.com/microsoft/recommenders) ⭐ 21,899 | 🐛 176 | 🌐 Python | 📅 2026-09-18 - A comparison of recommender system models (30 min)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,747 | 🐛 589 | 🌐 Python | 📅 2026-09-18 - A tool for labelling images (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,848 | 🐛 34 | 📅 2026-09-12 - An awesome list of Docker resources (30 min)
...
* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,798 | 🐛 44 | 🌐 Python | 📅 2026-09-18 - How to test and document your data and data pipelines (30 min)
