...
For more awesomeness, check out [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,664 | 🐛 102 | 📅 2026-08-18.
...
* :snake: [poetry](https://github.com/python-poetry/poetry) ⭐ 34,287 | 🐛 563 | 🌐 Python | 📅 2026-08-17 - Manage the packaging and dependencies of your Python project
...
* :snake: [commitizen](https://github.com/commitizen-tools/commitizen) ⭐ 3,495 | 🐛 183 | 🌐 Python | 📅 2026-08-17 - Check that commit messages satisfy [Conventional Commits](https://www.conventionalcommits.org/) and automate [Semantic Versioning](https://semver.org/) and [Keep a Changelog](https://keepachangelog.com/)
...
* :hatched\_chick: [black](https://github.com/psf/black) ⭐ 41,807 | 🐛 304 | 🌐 Python | 📅 2026-08-19 - Automatically format your code
* :snake: [mypy](https://github.com/python/mypy) ⭐ 20,597 | 🐛 3,191 | 🌐 Python | 📅 2026-08-15 - Check the type-correctness of your code
...
* :snake: [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,691 | 🐛 74 | 🌐 Python | 📅 2026-08-19 - Create RESTful APIs based on type annotations
* :snake: [streamlit](https://github.com/streamlit/streamlit) ⭐ 45,573 | 🐛 1,187 | 🌐 Python | 📅 2026-08-19 - Create web apps with a single Python file
* :snake: [typer](https://github.com/tiangolo/typer) ⭐ 19,907 | 🐛 41 | 🌐 Python | 📅 2026-08-12 - Create CLIs based on type annotations

#### Utilities

* :snake: [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,276 | 🐛 595 | 🌐 Python | 📅 2026-08-17 - Easily add progress bars to long-running jobs
* :snake: [mkdocs](https://github.com/mkdocs/mkdocs) ⭐ 22,359 | 🐛 185 | 🌐 Python | 📅 2025-10-20 - Create developer documentation for your project
* :snake: [viztracer](https://github.com/gaogaotiantian/viztracer) ⭐ 7,721 | 🐛 28 | 🌐 Python | 📅 2026-08-18 - Vizualize your code's performance with a [flamegraph](https://www.brendangregg.com/flamegraphs.html)
...
* :snake: [hvplot](https://github.com/holoviz/hvplot) ⭐ 1,356 | 🐛 398 | 🌐 Python | 📅 2026-08-19 - Create interactive plots from pandas dataframes
...
* :snake: [SHAP: SHapley Additive exPlanations](https://github.com/slundberg/shap) ⭐ 25,692 | 🐛 1,010 | 🌐 Jupyter Notebook | 📅 2026-08-11 - How to explain a model's output with Shapley values (30 min)
...
* :snake: [Darts - Time Series Made Easy in Python](https://github.com/unit8co/darts) ⭐ 9,498 | 🐛 222 | 🌐 Python | 📅 2026-08-06 - How to build forecasting models with `darts` (1 hour)
...
* :snake: [CVAT: Computer Vision Annotation Tool](https://github.com/openvinotoolkit/cvat) ⭐ 16,547 | 🐛 586 | 🌐 Python | 📅 2026-08-19 - A tool for labelling images (30 min)
* :snake: [Doccano](https://github.com/doccano/doccano) ⭐ 10,745 | 🐛 395 | 🌐 Python | 📅 2026-04-14 - A tool for labelling text (30 min)
...
* :unicorn: [Awesome Docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,668 | 🐛 12 | 📅 2026-08-18 - An awesome list of Docker resources (30 min)

### Data pipelines

* :snake: [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,718 | 🐛 29 | 🌐 Python | 📅 2026-08-19 - How to test and document your data and data pipelines (30 min)
...
* :unicorn: [Terraform pre-commit hooks collection](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,757 | 🐛 28 | 🌐 Shell | 📅 2026-08-18 - How to automate Terraform code quality checks with pre-commit (1 hour)
